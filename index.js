...
function Translate(type) {
  if (type == "de") {
    ...
    document.getElementById("devtext").innerHTML = "Web-/Software-Entwickler";
    ...
    document.getElementById("infotextfacts").innerHTML =
      "Hallo, ich bin Christian Jedrzejczyk, ein 18-jähriger Web- und Softwareentwickler aus der Nähe von Dortmund. Ich habe Erfahrung in verschiedenen Technologien, darunter:";
    ...
    document.getElementById("aboutmetexttext3").innerHTML = "Meine Projekte";
    ...
    document.getElementById("prjectinfos").innerHTML =
      "Ein Entwicklungsdienstleister mit Spezialisierung auf Websites, Skripterstellung und Anwendungen. </br></br> - Über 1.1k Kunden </br> - Über 80 Sonderanfertigungen </br> - 350.000 Benutzer vertrauen darauf </br> - 4 Jahre Erfahrung </br> – Über 20 Produkte";
    ...
    document.getElementById("devtext").innerHTML = "Web / Software Developer";
    ...
    document.getElementById("infotextfacts").innerHTML =
      "Hello, I'm Christian Jedrzejczyk, a 18-year-old web and software developer from near Dortmund. I have experience in various technologies, including:";
    document.getElementById("textskills").innerHTML =
    ...
    document.getElementById("prjectinfos").innerHTML =
      "A development service provider specializing in websites, scripting, and applications. </br></br> - Over 1.1k customers </br> - Over 80 custom projects </br> - Trusted by 350,000 users </br> - 4 years of experience </br> – Over 20 products";
    document.getElementById("prjectinfos2").innerHTML =
